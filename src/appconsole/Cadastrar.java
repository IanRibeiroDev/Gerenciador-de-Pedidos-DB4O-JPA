...
public class Cadastrar {
	...
	public Cadastrar() {
		try {
			...
			// Pedido
			Pedido p1 = new Pedido(Util.gerarIdPedido(), c10, q19, "M", LocalDateTime.now());
			manager.store(p1);
			manager.commit();

			Pedido p2 = new Pedido(Util.gerarIdPedido(), c7, q18, "G", LocalDateTime.now());
			manager.store(p2);
			manager.commit();

			Pedido p3 = new Pedido(Util.gerarIdPedido(), c15, q8, "P", LocalDateTime.now());
			manager.store(p3);
			manager.commit();

			Pedido p4 = new Pedido(Util.gerarIdPedido(), c12, q5, "M", LocalDateTime.now());
			manager.store(p4);
			manager.commit();

			Pedido p5 = new Pedido(Util.gerarIdPedido(), c18, q3, "G", LocalDateTime.now());
			manager.store(p5);
			manager.commit();

			Pedido p6 = new Pedido(Util.gerarIdPedido(), c20, q10, "P", LocalDateTime.now());
			manager.store(p6);
			manager.commit();

			Pedido p7 = new Pedido(Util.gerarIdPedido(), c3, q6, "P", LocalDateTime.now());
			manager.store(p7);
			manager.commit();

			Pedido p8 = new Pedido(Util.gerarIdPedido(), c16, q11, "G", LocalDateTime.now());
			manager.store(p8);
			manager.commit();

			Pedido p9 = new Pedido(Util.gerarIdPedido(), c19, q4, "M", LocalDateTime.now());
			manager.store(p9);
			manager.commit();

			Pedido p10 = new Pedido(Util.gerarIdPedido(), c9, q20, "M", LocalDateTime.now());
			manager.store(p10);
			manager.commit();

			Pedido p11 = new Pedido(Util.gerarIdPedido(), c13, q7, "G", LocalDateTime.now());
			manager.store(p11);
			manager.commit();

			Pedido p12 = new Pedido(Util.gerarIdPedido(), c1, q17, "P", LocalDateTime.now());
			manager.store(p12);
			manager.commit();

			Pedido p13 = new Pedido(Util.gerarIdPedido(), c4, q9, "G", LocalDateTime.now());
			manager.store(p13);
			manager.commit();

			Pedido p14 = new Pedido(Util.gerarIdPedido(), c14, q12, "P", LocalDateTime.now());
			manager.store(p14);
			manager.commit();

			Pedido p15 = new Pedido(Util.gerarIdPedido(), c8, q14, "G", LocalDateTime.now());
			manager.store(p15);
			manager.commit();

			Pedido p16 = new Pedido(Util.gerarIdPedido(), c2, q13, "M", LocalDateTime.now());
			manager.store(p16);
			manager.commit();

			Pedido p17 = new Pedido(Util.gerarIdPedido(), c17, q16, "P", LocalDateTime.now());
			manager.store(p17);
			manager.commit();

			Pedido p18 = new Pedido(Util.gerarIdPedido(), c20, q15, "G", LocalDateTime.now());
			manager.store(p18);
			manager.commit();

			Pedido p19 = new Pedido(Util.gerarIdPedido(), c5, q2, "M", LocalDateTime.now());
			manager.store(p19);
			manager.commit();

			Pedido p20 = new Pedido(Util.gerarIdPedido(), c11, q1, "P", LocalDateTime.now());
			manager.store(p20);
			manager.commit();

			Pedido p21 = new Pedido(Util.gerarIdPedido(), c6, q20, "P", LocalDateTime.now());
			manager.store(p21);
			manager.commit();

			Pedido p22 = new Pedido(Util.gerarIdPedido(), c15, q19, "G", LocalDateTime.now());
			manager.store(p22);
			manager.commit();

			Pedido p23 = new Pedido(Util.gerarIdPedido(), c12, q18, "M", LocalDateTime.now());
			manager.store(p23);
			manager.commit();

			Pedido p24 = new Pedido(Util.gerarIdPedido(), c18, q17, "M", LocalDateTime.now());
			manager.store(p24);
			manager.commit();

			Pedido p25 = new Pedido(Util.gerarIdPedido(), c9, q14, "G", LocalDateTime.now());
			manager.store(p25);
			manager.commit();

			Pedido p26 = new Pedido(Util.gerarIdPedido(), c4, q13, "P", LocalDateTime.now());
			manager.store(p26);
			manager.commit();

			Pedido p27 = new Pedido(Util.gerarIdPedido(), c17, q16, "M", LocalDateTime.now());
			manager.store(p27);
			manager.commit();

			Pedido p28 = new Pedido(Util.gerarIdPedido(), c20, q15, "G", LocalDateTime.now());
			manager.store(p28);
			manager.commit();

			Pedido p29 = new Pedido(Util.gerarIdPedido(), c5, q2, "M", LocalDateTime.now());
			manager.store(p29);
			manager.commit();

			Pedido p30 = new Pedido(Util.gerarIdPedido(), c11, q1, "P", LocalDateTime.now());
			manager.store(p30);
			manager.commit();
